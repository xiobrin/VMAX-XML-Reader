...
if p.returncode == 0:
    ...
    subscription = 0
    subscription = round(float(subscribed_cap/allocated_cap),2)
    ...
    while cacheslots < 24:
        for x in range(0, 8):
            ...
            test_cell = '=IF($C$19+$C$7>=1,IF(ROUND(($C$15+(($C$23/1000)*($C$10)))/($C$7+$C$19)/20,0)>=' + str(cacheslots + 1) + ',1,0))'
            ws[ENG1list[ENGcounter]] = test_cell
            test_cell = '=IF($C$19+$C$7>=2,IF(ROUND(($C$15+(($C$23/1000)*($C$10)))/($C$7+$C$19)/20,0)>=' + str(cacheslots + 1) + ',1,0))'
            ws[ENG2list[ENGcounter]] = test_cell
            test_cell = '=IF($C$19+$C$7>=3,IF(ROUND(($C$15+(($C$23/1000)*($C$10)))/($C$7+$C$19)/20,0)>=' + str(cacheslots + 1) + ',1,0))'
            ws[ENG3list[ENGcounter]] = test_cell
            test_cell = '=IF($C$19+$C$7>=4,IF(ROUND(($C$15+(($C$23/1000)*($C$10)))/($C$7+$C$19)/20,0)>=' + str(cacheslots + 1) + ',1,0))'
            ws[ENG4list[ENGcounter]] = test_cell
            test_cell = '=IF($C$19+$C$7>=5,IF(ROUND(($C$15+(($C$23/1000)*($C$10)))/($C$7+$C$19)/20,0)>=' + str(cacheslots + 1) + ',1,0))'
            ws[ENG5list[ENGcounter]] = test_cell
            test_cell = '=IF($C$19+$C$7>=6,IF(ROUND(($C$15+(($C$23/1000)*($C$10)))/($C$7+$C$19)/20,0)>=' + str(cacheslots + 1) + ',1,0))'
            ws[ENG6list[ENGcounter]] = test_cell
            test_cell = '=IF($C$19+$C$7>=7,IF(ROUND(($C$15+(($C$23/1000)*($C$10)))/($C$7+$C$19)/20,0)>=' + str(cacheslots + 1) + ',1,0))'
            #test_cell = '=IF($C$19+$C$7=8,IF(($C$15+(($C$23/1000)*($C$15/$C$14)))/($C$7+$C$19)/20>' + str(cacheslots + 1) + ',1,0))'
            ws[ENG7list[ENGcounter]] = test_cell
            test_cell = '=IF($C$19+$C$7>=8,IF(ROUND(($C$15+(($C$23/1000)*($C$10)))/($C$7+$C$19)/20,0)>=' + str(cacheslots + 1) + ',1,0))'
    ...
    #   '=IF($C$7=6,IF($C$22>=7,3084,0),IF($C$22>=9,3084,0))',
    #   '=IF($C$7=6,IF($C$22>=13,3084,0),IF($C$22>=17,3084,0))',
    #   '=IF($C$7=6,IF($C$22>=19,3084,0),IF($C$22>=25,3084,0))',
    ...
    for child in root.iter():
        ...
        if ident != None:
            ...
            #tid = child.find('tid')
            #   if interface != None:
                gigabytes = child.find('rated_gigabytes')
                failed = child.find('failed_disk')
                #print failed.text
                # converting text to integer
                i = int(gigabytes.text)
                ...
                if DAECounter == 1:
                    ...
                    while remainingslots > 4:
                        for x in range(0, 4):
                            ...
                            if engine_counter == 6:
                                test_cell = '=IF(($C$7+$C$19=' + str(EngineCount) + '),IF($C$22>=' + str(BalanceTracker + 1) + ',3084,0),IF($C$22>=' + str(BalanceTracker + 3) + ',3084,0))'
                            if engine_counter == 8:
                                test_cell = '=IF($C$22>=' + str(BalanceTracker + 1) + ',3084,0)'
                ...
                #print ident.text, interface.text, tid.text, gigabytes.text
                ...
                if DAECounter == 3:
                    ...
                    while remainingslots > 4:
                        for x in range(0, 4):
                            #print "We're on time %d" % (x)
                            if engine_counter == 6:
                                test_cell = '=IF(($C$7+$C$19=' + str(EngineCount) + '),IF($C$22>=' + str(BalanceTracker + 2) + ',3084,0),IF($C$22>=' + str(BalanceTracker + 4) + ',3084,0))'
                            if engine_counter == 8:
                                test_cell = '=IF($C$22>=' + str(BalanceTracker + 2) + ',3084,0)'
                ...
                if DAECounter == 5:
                    ...
                    while remainingslots > 4:
                        for x in range(0, 4):
                            #print "We're on time %d" % (x)
                            if engine_counter == 6:
                                test_cell = '=IF(($C$7+$C$19=' + str(EngineCount) + '),IF($C$22>=' + str(BalanceTracker + 3) + ',3084,0),IF($C$22>=' + str(BalanceTracker + 5) + ',3084,0))'
                            if engine_counter == 8:
                                test_cell = '=IF($C$22>=' + str(BalanceTracker + 3) + ',3084,0)'
                ...
                if DAECounter == 7:
                    ...
                    while remainingslots > 4:
                        for x in range(0, 4):
                            #print "We're on time %d" % (x)
                            if engine_counter == 6:
                                test_cell = '=IF(($C$7+$C$19=' + str(EngineCount) + '),IF($C$22>=' + str(BalanceTracker + 4) + ',3084,0),IF($C$22>=' + str(BalanceTracker + 6) + ',3084,0))'
                            if engine_counter == 8:
                                test_cell = '=IF($C$22>=' + str(BalanceTracker + 4) + ',3084,0)'
                ...
                if DAECounter == 9:
                    ...
                    while remainingslots > 4:
                        for x in range(0, 4):
                            #print "We're on time %d" % (x)
                            if engine_counter == 6:
                                test_cell = '=IF(($C$7+$C$19=' + str(EngineCount) + '),IF($C$22>=' + str(BalanceTracker + 5) + ',3084,0),IF($C$22>=' + str(BalanceTracker + 7) + ',3084,0))'
                            if engine_counter == 8:
                                test_cell = '=IF($C$22>=' + str(BalanceTracker + 5) + ',3084,0)'
                ...
                if DAECounter == 11:
                    ...
                    while remainingslots > 4:
                        for x in range(0, 4):
                            #print "We're on time %d" % (x)
                            if engine_counter == 6:
                                test_cell = '=IF(($C$7+$C$19=' + str(EngineCount) + '),IF($C$22>=' + str(BalanceTracker + 6) + ',3084,0),IF($C$22>=' + str(BalanceTracker + 8) + ',3084,0))'
                            if engine_counter == 8:
                                test_cell = '=IF($C$22>=' + str(BalanceTracker + 6) + ',3084,0)'
                ...
                if DAECounter == 13:
                    ...
                    while remainingslots > 4:
                        for x in range(0, 4):
                            #print "We're on time %d" % (x)
                            if engine_counter == 6:
                                test_cell = '=IF($C$19=0,0,IF($C$22>=' + str(BalanceTracker + 7) + ',3084,0))'
                            if engine_counter == 8:
                                test_cell = '=IF($C$22>=' + str(BalanceTracker + 7) + ',3084,0)'
                    ...
                    while remainingslots > 4:
                        for x in range(0, 4):
                            ...
                            if engine_counter == 6:
                                test_cell = '=IF($C$19=0,0,IF($C$22>=' + str(BalanceTracker + 7) + ',3084,0))'
                            if engine_counter == 8:
                                test_cell = '=IF($C$22>=' + str(BalanceTracker + 8) + ',3084,0)'
                        ...
                        if engine_counter == 6:
                            ...
                            if DAE13counter == 0:
                                while DAE13counter <=7:
                                    test_cell = '=IF($C$19=0,0,3084)'
                                    ws[DAE13list[DAE13counter]] = test_cell
                                    DAE13counter = DAE13counter + 1
                            test_cell = '=IF($C$19=0,0,IF($C$22>=' + str(BalanceTracker + 7) + ',3084,0))'
                            ws[DAE13list[DAE13counter]] = test_cell
                        if engine_counter == 8:
                            test_cell = '=IF($C$7>=6,0,IF($C$22>=' + str(BalanceTracker + 7) + ',3084,0))'
                            ws[DAE13list[DAE13counter]] = test_cell
                        DAE13counter = DAE13counter + 1
                    BalanceTracker = BalanceTracker + (DAECount / 2)
                remainingslots = remainingslots - 4
